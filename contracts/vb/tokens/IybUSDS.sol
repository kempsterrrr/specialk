...
/**
 * @title IybUSDS
 * @notice Interface for the Yield-Bearing USDS token on Sepolia
 * @dev Exposes yield from USDS while maintaining the ERC20 interface
 * @custom:sepolia 0x56b89A124376CB0481c93C3d94f821F262Dc0D7A
 */
interface IybUSDS is IYieldExposedToken {
    /**
