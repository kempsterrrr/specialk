...
/**
 * @title IybETH
 * @notice Interface for the Yield-Bearing ETH token on Sepolia
 * @dev Exposes yield from ETH while maintaining the ERC20 interface
 * @custom:sepolia 0x4CcD4CbDE5Ec758cCBf75f0be280647Ff359c17a
 */
interface IybETH is IYieldExposedToken {
    /**
